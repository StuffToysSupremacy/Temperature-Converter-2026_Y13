...
class Converter():
    ...
    def check_temp(self,min_temp):
        ...
        # Reset label and entry box (if we had error)
    ...
    def convert(self, min_temp, to_convert):
        ...
        Also stores calculation for Export / History feature
        """
...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        help_text =("To use the program, simply enter the temperature "
                    ...
                    "To see your "
                    "calculation and export it to a text "
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        # configure it to show the filename if the user export the file
